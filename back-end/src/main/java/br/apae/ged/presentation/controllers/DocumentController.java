...
public class DocumentController {
    ...
    private final DocumentService service;
        ...
        @Operation(summary = "Lista documentos enviados pelo usuário logado", description = "Retorna todos os documentos cujo uploaded_by é o usuário autenticado.")
        @GetMapping("/meus")
        public ResponseEntity<List<DocumentDTO>> listarMeusDocumentos() {
                var documentos = service.listarMeusDocumentos();
