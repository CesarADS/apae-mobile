  ...
  return (
    <Container fluid className="vh-100 p-0">
      <Row className="vh-100 p-0 m-0 gap-0">
        <Col md={8} className="d-none d-md-flex vh-100 flex-column justify-content-center align-items-center login p-0">
          <Image src="/img/Imagem.png" alt="Mapa do Brasil" className="mapa" />
        ...
        <Col md={4} className="d-flex vh-100 flex-column justify-content-center align-items-center bg-blue p-0">
          <Form onSubmit={handleSubmitEmail} className="w-75">
            ...
            <Button variant="outline-light" type="submit" className="w-100 btn-white mb-3" disabled={loading || showResetModal}>
      ...
      <Modal show={showResetModal} onHide={handleCloseResetModal} centered>
        ...
        <Form onSubmit={handleSubmitResetPassword}>
          ...
          <Modal.Footer>
            ...
            <Button variant="outline-light" type="submit" disabled={loadingModal} className="btn-white">
