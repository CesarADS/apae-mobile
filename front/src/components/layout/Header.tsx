...
const Header = (): ReactElement => {
    ...
    const navLinks: NavLinkItem[] = [
        { path: "/", text: "Início", icon: "fa-solid fa-house", permissions: ["ALUNOS", "DOCUMENTO_ALUNO_READ", "DOCUMENTO_COLABORADOR_READ", "DOCUMENTO_INSTITUCIONAL_READ", "TIPO_DOCUMENTO", "GRUPOS_PERMISSOES", "GERENCIAR_USUARIO", "GERENCIAR_COLABORADORES"] },
        {
            text: "Pessoa",
            icon: "fa-solid fa-users",
            permissions: ["ALUNO_READ", "COLABORADOR_READ"],
            subItems: [
                { path: "/alunos", text: "Alunos", icon: "fa-solid fa-user-graduate", permissions: ["ALUNO_READ"] },
                { path: "/colaboradores", text: "Colaboradores", icon: "fa-solid fa-user-tie", permissions: ["COLABORADOR_READ"] },
            ]
        },
        { 
            text: "Documentos", 
            icon: "fa-solid fa-folder-open", 
            permissions: ["DOCUMENTO_ALUNO_READ", "DOCUMENTO_COLABORADOR_READ", "DOCUMENTO_INSTITUCIONAL_READ", "TIPO_DOCUMENTO"],
            subItems: [
                {
                    text: "Gerenciar Documentos",
                    icon: "fa-solid fa-folder-open",
                    permissions: ["DOCUMENTO_ALUNO_READ", "DOCUMENTO_COLABORADOR_READ", "DOCUMENTO_INSTITUCIONAL_READ"],
                    subItems: [
                        { path: "/documentos/alunos", text: "Alunos", icon: "fa-solid fa-user-graduate", permissions: ["DOCUMENTO_ALUNO_READ"] },
                        { path: "/documentos/colaboradores", text: "Colaboradores", icon: "fa-solid fa-user-tie", permissions: ["DOCUMENTO_COLABORADOR_READ"] },
                        { path: "/documentos/instituicao", text: "Instituição", icon: "fa-solid fa-building-columns", permissions: ["DOCUMENTO_INSTITUCIONAL_READ"] },
                    ]
                },
                { path: "/tipo-documento", text: "Tipos de Documento", icon: "fa-solid fa-file-alt", permissions: ["TIPO_DOCUMENTO"] },
            ]
        },
        {path: "/verificacao", text: "Verificar Documento", icon: "bi bi-file-earmark-check-fill", permissions: ["DOCUMENTO_ALUNO_READ", "DOCUMENTO_COLABORADOR_READ", "DOCUMENTO_INSTITUCIONAL_READ"]},
        ...
        { 
            ...
            subItems: [
                ...
                { path: "/logs", text: "Logs do Sistema", icon: "fa-solid fa-file-alt", permissions: ["GRUPOS_PERMISSOES"] },
            ]
        }
           ];
                        ...
                        if (subItem.subItems) {
                            return (
                                <Dropdown drop="end" key={subItem.text}>
                                    <Dropdown.Toggle as="a" className="dropdown-item" style={{ cursor: "pointer" }}>
    ...
    return (
        <>
            <Navbar expand="lg" style={{backgroundColor: "#3877c9"}} variant="dark" className="shadow-sm px-md-3 py-2" sticky="top">
                <Container fluid>
                    <LinkContainer to="/">
                    ...
                    <div className="ms-auto d-flex align-items-center text-white">
                        ...
                        >
                            <NavDropdown.Item onClick={handleShowPasswordModal}>
                                <i className="fa-solid fa-key me-2 bg-white"></i>Alterar Senha
                            </NavDropdown.Item>
                            <NavDropdown.Divider />
